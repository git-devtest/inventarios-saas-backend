...
echo "==========================="
echo ""
echo "curl -X GET '$BASE_URL/inventarios/stock' \\"
echo "  -H 'Authorization: Bearer $TOKEN' \\"
echo "  -H 'Content-Type: application/json' \\"
echo "  -d '{"
echo "    \"producto_id\": \"$PRODUCTO_ID\","
echo "    \"almacen_id\": \"$ALMACEN_ORIGEN_ID\""
echo "  }'"
echo ""
...
echo "====================}"
echo ""
echo "curl -X GET '$BASE_URL/inventarios/kardex' \\"
echo "  -H 'Authorization: Bearer $TOKEN' \\"
echo "  -H 'Content-Type: application/json' \\"
echo "  -d '{"
echo "    \"producto_id\": \"$PRODUCTO_ID\","
echo "    \"almacen_id\": \"$ALMACEN_ORIGEN_ID\","
echo "    \"fecha_inicio\": \"2024-01-01T00:00:00Z\","
echo "    \"fecha_fin\": \"2024-12-31T23:59:59Z\""
echo "  }'"
echo ""
